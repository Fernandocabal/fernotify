...
(function () {
  ...
  function bootstrap(fn) {
    ...
    s.src = 'https://cdn.jsdelivr.net/npm/fernotify@2.1.0/dist/notification-system.min.js';
    s.onload = fn;
    s.onerror = function () {
      /* fallback: jsDelivr via GitHub */
      var cdn = document.createElement('script');
      cdn.src = 'https://cdn.jsdelivr.net/gh/Fernandocabal/fernotify@2.1.0/dist/notification-system.min.js';
      cdn.onload = fn;
