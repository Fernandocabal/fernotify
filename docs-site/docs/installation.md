...
FerNotify v2.1.2 no requiere ninguna dependencia externa. Solo incluye el script y listo.
...
<script src="https://cdn.jsdelivr.net/gh/Fernandocabal/fernotify@2.1.2/dist/notification-system.js"></script>
```
